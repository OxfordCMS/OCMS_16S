...
scriptsdir = os.path.basename(pipelines.pipeline_dada2.__file__).replace("pipelines", "R")
...
def build_report():
    ...
    '''
    reportdir = os.path.basename(pipelines.pipeline_dada2.__file__).replace("pipelines", "docs/Rmd/pipeline_dada2")
